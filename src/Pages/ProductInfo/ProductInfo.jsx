                    ...
                    <div className="flex flex-wrap mb-24 -mx-4">
                            ...
                            <div className="">
                                <div className="">
                                    <img
                                        ...
                                        src="https://assets.ajio.com/medias/sys_master/root/20240313/TO64/65f12ae816fd2c6e6a547d57/linza-white-classic-men-printed-slim-fit-shirt-with-full-sleeves.jpg"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div className="w-full px-4 md:w-1/2">
                            <div className="lg:pl-20">
                                <div className="mb-6 ">
                                    <h2 className="max-w-xl mb-6 text-xl font-semibold leading-loose tracking-wide text-gray-800 md:text-2xl dark:text-gray-800">
                                       Shop Hand Painted Blue Kaushalam Tea Pot in Aluminium, handmade by Mrinalika Jain. Fair pricing. Ethically made. Pos
                                    </h2>
                                ...
                                <div className="flex flex-wrap items-center mb-6">
                                    ...
                                    <button
                                        className="w-full px-4 py-3 text-cente bg-gray-800 hover:bg-gray-600 w-full text-white rounded-xl"
                                    >
                                        Add to cart
                                    </button>
                                </div>
