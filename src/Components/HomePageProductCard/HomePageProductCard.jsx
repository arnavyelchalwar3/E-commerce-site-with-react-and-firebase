...
//             {/* Heading  */}
//             <div className="">
//                 <h1 className=" text-center mb-5 text-2xl font-semibold">Latest Products</h1>
//             </div>
                                ...
                                <div key={id} className="p-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
                                    <div className="h-full border border-gray-300 rounded-xl overflow-hidden shadow-md cursor-pointer">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex justify-center">
                                                <button className="bg-gray-800 hover:bg-gray-600 w-full text-white py-2 rounded-lg font-bold">
                                                    Add To Cart
                                                </button>
                                            </div>
                                        </div>
