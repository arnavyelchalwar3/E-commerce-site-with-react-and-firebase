    ...
    return (
        <Layout>
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    {/* main  */}
                    <div className=" bg-gray-200 py-5 rounded-xl border border-grey-400">
                        {/* image  */}
                        <div className="flex justify-center">
                ...
                <div className="bottom">
                    ...
                    <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
                        ...
                        {/* main 2 */}
                        <div className="mt-5 flex flex-col overflow-hidden rounded-xl border border-grey-300 md:flex-row">
                            {/* main 3  */}
                            <div className="w-full border-r border-grey-300 bg-grey-200 md:max-w-xs">
                                {/* left  */}
                                <div className="p-8">
                                    <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                        <div className="mb-4">
