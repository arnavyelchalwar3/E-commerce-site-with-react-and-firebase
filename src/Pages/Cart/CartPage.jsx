                                        ...
                                        <div className="mb-2 flex">
                                            ...
                                            <div className="ml-6 flex text-sm">
                                                <button type="button" className="flex items-center space-x-1 px-2 py-1 pl-0">
                                                    <Trash size={12} className="text-gray-800" />
                                                    <span className="text-xs font-medium text-gray-800">Remove</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="flex gap-4 mb-6">
                                    <button
                                        className="w-full px-4 py-3 text-center text-gray-100 bg-gray-800 border border-transparent dark:border-gray-700 hover:border-gray-500 hover:text-gray-700 hover:bg-pink-100 rounded-xl"
                                    >
                                        Buy now
                                    </button>
                                </div>
