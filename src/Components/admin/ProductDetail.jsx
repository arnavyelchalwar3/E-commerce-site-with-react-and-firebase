    ...
    return (
        <div>
            <div className="py-5 flex justify-between items-center">
                {/* text  */}
                <h1 className=" text-xl text-black-300 font-bold">All Products </h1>
                {/* Add Product Button  */}
                <Link to="/addproduct">
                <button className="px-5 py-2 bg-gray-300 border border-gray-100 rounded-lg">Add Product</button>
                </Link>
            </div>
