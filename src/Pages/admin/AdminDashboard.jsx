            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    ...
                    <div className=" bg-gray-200 py-5 rounded-xl border border-gray-300 ">
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg text-black-500"><span className=" font-bold">Name :</span> Amey Patill</h1>
                ...
                <div className="">
                    <div className="flex flex-wrap -m-4 text-center justify-center">
                        ...
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                            <div className=" border bg-gray-200 hover:bg-gray-100 border-gray-300 px-4 py-3 rounded-xl" >
                                ...
                                <p className=" text-gray-200  font-bold" >Total Products</p>
                            </div>
                        </div>
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                            <div className=" border bg-gray-200 hover:bg-gray-100 border-gray-300 px-4 py-3 rounded-xl" >
                                ...
                                <h2 className="title-font font-medium text-3xl text-black-200 fonts1" >10</h2>
                                <p className=" text-black-300  font-bold" >Total Order</p>
                            </div>
                        </div>
                        ...
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                            <div className=" border bg-gray-200 hover:bg-gray-100 border-gray-300 px-4 py-3 rounded-xl" >
                                <div className="text-black-400 w-12 h-12 mb-3 inline-block" >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={50}
                                        height={50}
                                ...
                                <h2 className="title-font font-medium text-3xl text-black-400 fonts1" >10</h2>
                                <p className=" text-black-400  font-bold" >Total Order</p>
                            </div>
                        </div>
                    </div>
                </div>
